...
ability = st.sidebar.slider("Student Ability (0-1)", 0.0, 1.0, 0.7, 0.05)
engagement = st.sidebar.slider("Engagement Level (0-1)", 0.0, 1.0, 0.6, 0.05)
difficulty = st.sidebar.slider("Content Difficulty (0-1)", 0.0, 1.0, 0.5, 0.05)
prior_attempts = st.sidebar.number_input("Prior Attempts", min_value=0, max_value=20, value=3)
time_since_last = st.sidebar.slider("Days Since Last Study", 0.0, 30.0, 2.0, 0.5)
